...
SUPABASE_URL = "https://mvvancoshtaxgrfyxuyq.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "sb_publishable_xSsd7LGYfxfcTzrijNfAsA_CAxUvPPB" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23CS527.jpeg"  # Replace with the local image path
image_name = "PES2UG23CS527.jpeg"  # Desired name for the uploaded file
